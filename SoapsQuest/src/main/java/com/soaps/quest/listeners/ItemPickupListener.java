...
/**
 * Listener for item collect quests.
 */
public class ItemPickupListener implements Listener {
    ...
    /**
     * Constructor for ItemPickupListener.
     * 
    ...
    /**
     * Handle item pickup events for quest progress.
    ...
    public void onItemPickup(EntityPickupItemEvent event) {
        ...
        int itemAmount = event.getItem().getItemStack().getAmount();
        ...
        for (ItemStack item : contents) {
            ...
            // Skip if quest is legacy type but not COLLECT
            if (!quest.hasObjectives() && quest.getType() != QuestType.COLLECT) {
                continue;
            }
            ...
            if (quest.hasObjectives()) {
                ...
                // LEGACY: Single-type quest with amount
                if (quest.checkProgress(player, event.getItem().getItemStack().getType())) {
                    questProgress.incrementProgress(itemAmount);
                    progressMade = true;
                }
            }
