...
extends AbstractObjective {
    ...
    public ShearObjective(String objectiveId, EntityType targetEntity, int requiredAmount, List<Integer> milestones) {
    ...
    public boolean handleEvent(Player player, Event event) {
        ...
        PlayerShearEntityEvent shearEvent = (PlayerShearEntityEvent)event;
        if (this.targetEntity != null && shearEvent.getEntity().getType() != this.targetEntity) {
            return false;
        }
    ...
    public String getProgressString(UUID playerId) {
        ...
        String entityName = this.targetEntity != null ? this.targetEntity.name() : "ENTITIES";
    ...
    public String getDescription() {
        ...
        return "Shear " + this.getRequiredAmount() + " " + entityName;
    }
